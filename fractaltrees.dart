...
void drawTree(CanvasRenderingContext2D ctx, int x1 , int y1, int angle, int depth, bool trunk, int scale ){
  ...
  if (depth>0)
  {
    ...
    drawTree(ctx, x2, y2, (angle-20) - rng.nextInt(25), depth - 1, false, scale);
    drawTree(ctx, x2, y2, (angle+20) + rng.nextInt(25), depth - 1, false, scale);
